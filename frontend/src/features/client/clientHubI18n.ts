...
const COPY: Record<ClientHubLocale, ClientHubCopy> = {
  'pt-PT': {
    ...
    home: {
      ...
      scheduleAnother: 'Marcar nova consultoria',
    },
    obligations: {
  ...
  'pt-BR': {
    ...
    home: {
      ...
      scheduleAnother: 'Marcar outra consultoria',
    },
    obligations: {
      empty: 'Sem obrigações neste período.',
      due: 'Prazo',
  ...
  en: {
    ...
    home: {
      ...
      upcomingConsultations: 'Your upcoming appointments',
    ...
    booking: {
      emptyServices: 'Your firm has not set up online scheduling yet.',
      pickService: 'Service',
      ...
      reserved: 'Appointment confirmed',
      confirmError: 'Could not complete the appointment',
      myUpcoming: 'My upcoming meetings',
      noMyUpcoming: 'No appointments yet. Pick a service and time below.',
    },

...
export const postSaftEfatura: BlogPost = {
  ...
  readMinutes: 16,
  coverImage: {
    src: 'https://images.unsplash.com/photo-1554224154-26032ffc0d62?w=1200&h=630&fit=crop&q=80&auto=format',
    alt: 'Documentos fiscais e calculadora organizados sobre secretária',
    width: 1200,
    height: 630,
  },
  seo: {

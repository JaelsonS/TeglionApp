...
export const postCasoEniLda: BlogPost = {
  ...
  readMinutes: 15,
  coverImage: {
    src: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1200&h=630&fit=crop&q=80&auto=format',
    alt: 'Documentos financeiros e calculadora em secretária de trabalho',
    width: 1200,
    height: 630,
  },
  seo: {

...
export const postCasoDigitalizacao: BlogPost = {
  ...
  author: 'Equipa editorial TegLion',
  ...
  readMinutes: 14,
  coverImage: {
    src: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&h=630&fit=crop&q=80&auto=format',
    alt: 'Secretária de escritório com portátil, documentos e calendário de trabalho',
    width: 1200,
    height: 630,
  },
  seo: {
  ...
  blocks: [
    ...
    ...articleSection({
      ...
      id: 'licoes',
      paragraphs: [
        'Digitalizar a relação com o cliente não substitui o ERP nem o TOC. Substitui o caos da última milha. Prazos precisam de dono e de data interna. O cliente colabora mais quando vê o estado do pedido — não quando recebe a quinta mensagem de voz às 22h.',

...
export const postIrcSociedadesLda: BlogPost = {
  ...
  readMinutes: 18,
  coverImage: {
    src: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200&h=630&fit=crop&q=80&auto=format',
    alt: 'Documentos fiscais, calculadora e caneta sobre secretária de trabalho',
    width: 1200,
    height: 630,
  },
  seo: {

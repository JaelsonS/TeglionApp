...
export const postAbrirSociedadeLda: BlogPost = {
  ...
  readMinutes: 17,
  coverImage: {
    src: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&h=630&fit=crop&q=80&auto=format',
    alt: 'Assinatura de documentos empresariais sobre secretária',
    width: 1200,
    height: 630,
  },
  seo: {

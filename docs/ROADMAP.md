...
- **Fase 4 — MFA: `EM ANDAMENTO`.** Plano técnico aprovado com gates (21/08/2026). Branch `feature/fase-4-mfa`. Staging-first; sem produção/Cloudflare/Vercel/DNS/`main`. Incidente de schema MFA órfão em produção: `docs/security/MFA_PROD_SCHEMA_INCIDENT.md` (não corrigir nesta fase).
